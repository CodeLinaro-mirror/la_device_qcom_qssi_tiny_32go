...
TARGET_BOARD_SUFFIX := _tiny_32go
TARGET_BOOTLOADER_BOARD_NAME := qssi_tiny_32go
...
DEVICE_PACKAGE_OVERLAYS += device/qcom/qssi_tiny_32go/overlay-go/device
PRODUCT_PACKAGE_OVERLAYS += device/qcom/qssi_tiny_32go/overlay-go/product
endif
...
VENDOR_QTI_PLATFORM := qssi_tiny_32go
VENDOR_QTI_DEVICE := qssi_tiny_32go
...
PRODUCT_COPY_FILES += \
    device/qcom/qssi_tiny_32go/init.qcom.testscripts.sh:$(TARGET_COPY_OUT_PRODUCT)/etc/init.qcom.testscripts.sh
endif
