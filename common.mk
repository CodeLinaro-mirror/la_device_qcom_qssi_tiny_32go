$(call inherit-product, device/qcom/qssi_tiny_32go/base.mk)
...
PRODUCT_COPY_FILES += \
    device/qcom/qssi_tiny_32go/qti_whitelist.xml:system/etc/sysconfig/qti_whitelist.xml \
    device/qcom/qssi_tiny_32go/qti_whitelist_system_ext.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/sysconfig/qti_whitelist_system_ext.xml

PRODUCT_COPY_FILES += \
    device/qcom/qssi_tiny_32go/privapp-permissions-qti.xml:system/etc/permissions/privapp-permissions-qti.xml \
    device/qcom/qssi_tiny_32go/privapp-permissions-qti-system-ext.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-qti-system-ext.xml
